...
extension LocationManager {
    ...
    func isHasAccess() -> Bool {
        ...
        if let authStatus = authorizationStatus {
...
extension LocationManager: CLLocationManagerDelegate {
    func locationManagerDidChangeAuthorization(_ manager: CLLocationManager) {
        ...
        print("locationManagerDidChangeAuthorization" , authorizationStatus)
        Bus.shared.post(event: .LocationAuthUpdate, userInfo: ["status": authorizationStatus, "state": self.state])
    }
